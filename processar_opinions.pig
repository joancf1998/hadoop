...
STORE avg_rate_group_max_min INTO '/user/cloudera/pig_analisis_opinions3/resultat_analisis_opinions_max_min3' USING org.apache.pig.piggybank.storage.CSVExcelStorage(',', 'YES_MULTILINE');
